...
T = readtable('df_best_func_rmap_ch.csv');
...
wjn_plot_colored_spheres(nmni,ba-0.5, 1.5,cm)  %wjn_gaussianize % change r to 2
%colorbar
hold on 
%camzoom(2)
set(gcf,'color','none')
